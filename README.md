...
| :---: | :---: | :---: | :---: |
| **v2.2** | Актуальная версия | [Ознакомиться](https://github.com/UIDevStudio/ViperTerm/releases/tag/terminal_v2.2) | [Скачать](https://github.com/UIDevStudio/ViperTerm/releases/download/terminal_v2.2/ViperTerm.exe) |
