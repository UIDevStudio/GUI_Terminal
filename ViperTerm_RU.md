...
| :---: | :---: | :---: | :---: |
| **v2.3** | Актуальная версия | [Ознакомиться](https://github.com/UIDevStudio/ViperTerm/releases/tag/terminal_v2.3) | [Скачать](https://github.com/UIDevStudio/ViperTerm/releases/download/terminal_v2.3/ViperTerm.exe) |
...
| v2.1 | Устаревшая версия | [Ознакомиться](https://github.com/UIDevStudio/ViperTerm/releases/tag/terminal_v2.1) | [Скачать](https://github.com/UIDevStudio/ViperTerm/releases/download/terminal_v2.1/ViperTerm.exe) |
...
| Версия | Статус | Ссылка на релиз | Ссылка на файл |
| :---: | :---: | :---: | :---: |
| **v2.3** | Актуальная версия | [Ознакомиться](https://github.com/UIDevStudio/ViperTerm/releases/tag/terminal_v2.3) | [Скачать](https://github.com/UIDevStudio/ViperTerm/releases/download/terminal_v2.3/ViperTerm_Installer.exe) |
